...
Классический мониторинг отвечает на вопрос «*что* сломалось»: метрики показывают рост CPU, логи — стек ошибок, трейсы — медленный сервис. Но когда нужно ответить «*почему* именно этот сервис стал медленным», почти все инструменты пасуют. Вы видите, что контейнер жуёт 2 ядра, но не видите, какая строка кода их жуёт. Начинается классический процесс: локально прогнать `pprof`/`py-spy`/`async-profiler`, попытаться воспроизвести нагрузку, угадать тестовые данные.
